...
$l['advadsman_ads_edit_relative_desc'] = 'The setting allows increasing or decreasing the time interval during which the advertisement is displayed. At this moment, expiration date is {1}.';
